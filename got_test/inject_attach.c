...
int main(int argc, const char* argv[]) {
    ...
    unsigned long func_addr_inject = get_func_addr(child,lib_name,func_name_inject);
    printf("func_addr_inject: %lx\n",func_addr_inject);
    ...
    replace_got(child,got_addr,func_addr_inject);
